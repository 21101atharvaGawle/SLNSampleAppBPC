...
namespace SampleAppBPC4.Repository
{
    ...
    internal class AnotherGenericRepository<T> : IGenericRepository<T> where T : class
    {
        private readonly AppDbContext _Mcontext;

        internal DbSet<T> _dbSet;

        public AnotherGenericRepository(AppDbContext Context)
        {
            _Mcontext = Context;
