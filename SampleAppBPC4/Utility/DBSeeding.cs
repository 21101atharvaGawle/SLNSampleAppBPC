...
namespace SampleAppBPC4.Utility
{
    public class DBSeeding : IDBSeeding
    {
        ...
        public void Initialize()
        {
            ...
            if (!_roleManager.RoleExistsAsync("Admin").GetAwaiter().GetResult())
            {
                ...
                {
                    UserName = "AtharvaGawle",
                    Email = "atharvagawle@gmail.com",
                    FirstName = "Admin",
                    LastName = "Admin",
                ...
                var Appuser = _context.Users.FirstOrDefault(x => x.Email == "atharvagawle@gmail.com");
                if (Appuser != null)
                {
